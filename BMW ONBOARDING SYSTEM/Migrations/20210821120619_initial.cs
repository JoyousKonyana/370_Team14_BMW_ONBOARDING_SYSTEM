...
namespace BMW_ONBOARDING_SYSTEM.Migrations
{
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_UserNotification", x => x.UserID);
            //        table.ForeignKey(
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_EquipmentQueryStatus", x => x.EquipmentQueryID);
            //        table.ForeignKey(
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_EquipmentQueryStatus_EquipmentQueryStatusID",
